...
exports.uu3 = exports.uu2 = exports.uu1 = exports.uu1origin = exports.yyy = void 0;
const origin = {
    ...
    Table1: {
        ...
        name: 'table',
        option: {
            columns: "{title:'设备',dataIndex:'deviceID'},{title:'数值',dataIndex:'value'},{title:'时间',dataIndex:'time'},",
            columnsAction: [],
            data: 'tableData',
            loading: 'loading',
            stripe: 'true',
    ...
    Table2: {
        ...
        name: 'table',
        option: {
            columns: "{title:'设备',dataIndex:'deviceID'},{title:'连接时间',dataIndex:'time'},",
    ...
    Switch1: {
        ...
        option: {
            ...
            onChange: "(e)=>{console.log('switch1checked to', e);set_switch1checked(e);}"
        },
        content: { text: '' }
    },
    Slider1: {
...
const vv1 = new Map();
Object.keys(exports.uu1origin).map((item) => {
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    vv1.set(item, exports.uu1origin[item]);
});
exports.uu1 = vv1;
...
exports.uu2 = vv2;
exports.uu3 = JSON.parse('[{"name":"实时数据","key":"menu-active-data","path":"active-data","icon":"IconStar"},{"name":"历史数据","key":"menu-fresh-manage-signup","path":"history","icon":"IconStar"},{"name":"设备管理","key":"menu-fresh-manage-interview","path":"manage","icon":"IconStar"}]');
